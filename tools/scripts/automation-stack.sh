...
AUTO_STORYCLUSTER_PORT_FALLBACK_BASE="${AUTO_STORYCLUSTER_PORT_FALLBACK_BASE:-24300}"
AUTO_STORYCLUSTER_PORT_FALLBACK_PROBE_COUNT="${AUTO_STORYCLUSTER_PORT_FALLBACK_PROBE_COUNT:-24}"
...
do_ensure() {
  ...
  AUTO_STORYCLUSTER_PORT="$(
    resolve_bindable_tcp_port \
      "$AUTO_STORYCLUSTER_PORT" \
      "$AUTO_STORYCLUSTER_PORT_FALLBACK_BASE" \
      "$AUTO_STORYCLUSTER_PORT_FALLBACK_PROBE_COUNT" \
      storycluster
  )" || die "Could not resolve a bindable StoryCluster port"
