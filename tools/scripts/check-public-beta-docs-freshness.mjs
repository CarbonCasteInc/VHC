...
const FORBIDDEN_CURRENT_LIVE_PATTERNS = [
  ...
  /\brecovery (?:is|has been) (?:complete|completed|successful|green)\b/i,
  /\brecovery has (?:successfully )?(?:completed|succeeded)\b/i,
  /\brecovery (?:completed|succeeded)\b/i,
  /\blaunch (?:may|can|should|will) (?:proceed|go (?:ahead|live))\b/i,
  /\blaunch is (?:allowed|approved|cleared) to (?:proceed|go (?:ahead|live))\b/i,
