...
export const NewsCardFront: React.FC<NewsCardFrontProps> = ({
  ...
  <section data-testid={`news-card-front-${item.topic_id}`} data-story-id={storyId ?? undefined}>
    {heroImage && (
      <div className="mb-5" data-testid={`news-card-hero-${item.topic_id}`}>
    ...
    <header className="mb-4 flex items-start justify-between gap-4">
      <div className="flex flex-wrap items-center gap-2">
        <span className="rounded-full bg-sky-50 px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.2em] text-sky-900 dark:bg-sky-950/60 dark:text-sky-100">
          News
        </span>
