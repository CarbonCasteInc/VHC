  ...
  it('registers the real-article ongoing-event replay scenarios in the default replay corpus', () => {
    expect(STORYCLUSTER_REPLAY_SCENARIOS.map((scenario) => scenario.scenario_id)).toEqual(
      expect.arrayContaining([
        ...
        'replay-known-event-birthright-arguments-source-growth',
        ...
        'replay-known-event-cuba-tanker-source-growth',
        'replay-known-event-cuba-tanker-vs-trump-opinion-separation',
        'replay-known-event-dhs-airport-shutdown-source-growth',
