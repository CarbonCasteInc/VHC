...
describe('resolveDaemonFeedSourcesJson', () => {
  it('resolves smoke-only sources that are not part of the starter default list', () => {
    process.env.VH_LIVE_DEV_FEED_SOURCE_IDS = 'abc-politics,huffpost-us,usatoday-politics,cnn-politics,pbs-politics';
    ...
    expect(sources[2].rssUrl).toBe('http://127.0.0.1:2148/rss/usatoday-politics');
