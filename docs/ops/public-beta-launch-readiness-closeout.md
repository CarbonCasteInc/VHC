...
Limited gate rerun, 2026-05-31: PR #631 now also hard-exits the public feed composition/freshness and lifecycle accountability CLI gates after artifacts are written, matching the browser smoke runner and preventing lingering Gun/browser helper sockets from turning a completed evidence run into a hung command. Current limited live evidence passed and exited cleanly for the top 10 public rows: `.tmp/release-evidence/public-feed-composition-freshness/1780237217539/public-feed-composition-freshness-summary.json` reported 10 readable latest rows, 7 singleton, 3 multi-source, 10 pending synthesis, and all configured public relay origins passing the one-story readback sample; `.tmp/release-evidence/public-feed-lifecycle-accountability/1780237133451/public-feed-lifecycle-accountability-summary.json` reported 10/10 product-visible rows, 7 singleton, 3 multi-source, 0 visible rows missing hot index, and 10/10 complete hot-index product metadata. This remains limited recovery evidence: accepted synthesis/frame-table readiness is still 0 in the sampled live feed, and stale direct Gun signer warnings remain cleanup work.
