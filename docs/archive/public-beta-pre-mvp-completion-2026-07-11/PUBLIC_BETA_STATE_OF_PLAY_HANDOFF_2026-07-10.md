...
4. `docs/ops/news-aggregator-production-service.md` - publisher procedure;
5. `docs/ops/public-beta-launch-readiness-closeout.md` - release claim boundary;
6. `docs/plans/PUBLIC_BETA_NEXT_PHASE_SPRINT_CHECKLIST_2026-07-09.md` -
   executable delegated sequence.
