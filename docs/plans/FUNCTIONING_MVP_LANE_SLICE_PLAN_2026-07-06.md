...
> `docs/sprints/PUBLIC_BETA_MVP_COMPLETION_SPRINT_2026-07-11.md` for the active
> completion sprint and `docs/ops/public-beta-operational-state.md` for the live
> gate.
